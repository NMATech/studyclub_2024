  ...
  return (
    <footer className="mt-[30px]">
      <div className="flex flex-col justify-center items-center p-2">
        <h1 className="text-3xl md:text-4xl font-bold text-myText">
          Studyclub
        </h1>
        ...
        <div className="w-max md:w-[80%] mx-auto border-t border-myText mt-[20px]">
          <ul className="flex justify-center items-center gap-2 md:gap-10 mt-[20px]">
            {footlink.map((link) => {
              return (
                <li className="transition duration-300 ease-in transform hover:translate-y-1 text-myText text-xl md:text-2xl hover:text-myAccent">
                  <a href={link.link}>{link.title}</a>
                </li>
              );
            })}
          </ul>
          <div className="text-mySecondary text-center mt-[20px]">
